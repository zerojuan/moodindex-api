...
describe('Delete User', () => {
  ...
  it('- Should not delete yourself', async () => {
    ...
    await expect(DeleteUser(fixture)).rejects.toMatchObject(new errors.ConflictError(
      'ConflictError: cannot delete self'
    ))
  })
  ...
  it('- Should NotFoundError on unknown user to delete', async () => {
    ...
    await expect(DeleteUser(fixture)).rejects.toMatchObject(new errors.NotFoundError(
